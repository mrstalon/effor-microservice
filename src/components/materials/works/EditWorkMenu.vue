        ...
        <div class="modal-mask" >
            <div class="modal-wrapper">
                <div class="modal-container" v-on:click="preventBubling">
                    <h1><span>Изменение проверочной работы</span></h1>
                    ...
                    <div class="buttons-container">
                        <button @click="approveWorkChanges()">Сохранить</button>
...
<script>
import Description from './edit-work/Description';
import Tasks from './edit-work/Tasks';
...
export default {
    ...
    methods: {
        ...
        approveWorkChanges() {
            this.$store.dispatch('approveWorkChanges')
                .then(() => {
                    this.$emit('close');
                });
        },
